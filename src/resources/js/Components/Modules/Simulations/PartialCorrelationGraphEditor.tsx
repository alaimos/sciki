...
import PartialCorrelationGraph from "../../Wiki/Plugins/Modules/Simulations/PartialCorrelationGraph";
import { useDispatcherEventWithSender } from "../../../Hooks/useDispatcherEvent";
import { SelectedSimulation } from "../../Wiki/Plugins/Modules/Simulations/CorrelationGraph";
...
interface State {
    plugin: "Modules/Simulations/PartialCorrelationGraph";
    id?: string;
    simulation: number;
    compareWith?: number;
    fn: Correlation;
